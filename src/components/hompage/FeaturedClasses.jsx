      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {classes.map((cls) => (
            <div
              key={cls.id}
              className="bg-gradient-to-r space-y-5 from-[#071E22] to-[#0F3D3E] border border-white/10 rounded-xl p-5 text-white hover:scale-[1.02] transition"
            >
              {/* Image */}
              ...
              <h3 className="text-xl font-bold mt-6">{cls.className}</h3>

              <p className="text-gray-400 mt-1 text-2xl">
